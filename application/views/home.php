...
<body>
	...
	<div class="row justify-content-center">
		...
		<div class="col-4" id="logo-wrapper">
			Logo belongs to here
		</div>
	</div>
	<div class="menu-wrapper">
		...
		<div class="row justify-content-center">
			<div class="col-12">
				<a href="<?= base_url('main/dzikir_pilihan') ?>" title="">
					<div class="menu-item">
						Dzikir Pilihan
					</div>
				</a>
